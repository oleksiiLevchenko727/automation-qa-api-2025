...
describe('API test for jsonplaceholder', () => {
    ...
    test('Should check users list', async () => {
    ...
    test('Should check user #4 by ID', async () => {
    ...
    test('Should check user #5 by ID and title', async () => {
    ...
    test('Should check user #6 by ID and body', async () => {
    ...
    test('Should create a new user with own data', async () => {
        const requestBody = {
